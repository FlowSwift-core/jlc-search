...
输出格式（严格 JSON）：
{
    "parsed_query": "标准化查询描述",
    "category": "类别名称或 null",
    "subcategory": "子类名称或 null",
    "mfr_pattern": "型号匹配模式或 null",
    "package": "封装或 null",
    "strict_filters": {
...
重要规则：
1. 类别必须准确！搜索"连接器"必须 category=Connectors
2. 搜索 LED 时 category=Optoelectronics, subcategory=Light Emitting Diodes
3. 型号使用精确匹配：STM32F103C8T6 -> mfr_pattern="STM32F103C8T6"
4. 电阻值用代码：10K -> mfr_pattern="1002"
5. 颜色用大写：RED, GREEN, BLUE
6. 不要猜测，不确定的字段设为 null

示例：
用户：USB-C 连接器
输出：{"parsed_query":"USB Type-C 连接器","category":"Connectors","subcategory":"USB Connectors","mfr_pattern":"USB","package":null,"strict_filters":{"must_be_category":true,"is_ic":false}}

用户：10K 0603 电阻
输出：{"parsed_query":"10K 0603 电阻","category":"Resistors","subcategory":"Chip Resistor - Surface Mount","mfr_pattern":"1002","package":"0603","strict_filters":{"must_be_category":true,"is_ic":false}}

用户：STM32F103C8T6
输出：{"parsed_query":"STM32F103C8T6","category":"Embedded Processors & Controllers","subcategory":"ST Microelectronics","mfr_pattern":"STM32F103C8T6","package":null,"strict_filters":{"must_be_category":false,"is_ic":true}}

用户：LED 红色 0805
输出：{"parsed_query":"红色 LED 0805","category":"Optoelectronics","subcategory":"Light Emitting Diodes (LED)","mfr_pattern":"0805R","package":"0805","strict_filters":{"must_be_category":true,"is_ic":false}}

用户：100nF 电容
输出：{"parsed_query":"100nF 电容","category":"Capacitors","subcategory":"Multilayer Ceramic Capacitors","mfr_pattern":"104","package":null,"strict_filters":{"must_be_category":true,"is_ic":false}}
"""
